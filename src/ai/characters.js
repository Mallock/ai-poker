...
const characters = [
  {
    ...
    playStyle: 'loose-aggressive — opens wide from late position, leads turns on scary boards, runs frequent semi-bluffs with backdoor equity',
  ...
  },
  {
    ...
    playStyle: 'tight-passive trap player — slow-plays strong hands, check-calls flops, raises rivers with disguised value',
  ...
  },
  {
    ...
    playStyle: 'maniac — frequent three-bets and four-bets, fearless all-ins, light squeezes from the blinds',
  ...
  },
  {
    ...
    playStyle: 'tight-aggressive (TAG) — solid fundamentals, exploits obvious leaks, rarely creative but never wrong',
  ...
  },
  {
    ...
    playStyle: 'pressure-driven aggressor — leverages stack size, isolates short stacks, oversizes flop bets',
  ...
  },
  {
    ...
    playStyle: 'observant exploiter — adjusts ranges hand by hand based on opponent tendencies, picks the weakest player and pressures them relentlessly',
  ...
  },
  {
    ...
    playStyle: 'GTO-leaning solver — balanced ranges, mixed strategies, near-perfect bet sizing, occasional exploitative deviations against obvious mistakes',
  ...
  },
  {
    ...
    playStyle: 'crafty exploiter — small-ball aggression, river-bluff specialist, masters of the under-bet and the over-bet',
  ...
  },
  {
    ...
    playStyle: 'erratic LAG — wildly varying bet sizes, frequent surprising shoves, occasional inexplicable folds',
  ...
  },
  {
    ...
    playStyle: 'aggressive 3-bet artist — light four-bets, polarized river jams, range-aware preflop',
